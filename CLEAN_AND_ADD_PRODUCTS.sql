-- ============================================================================
-- CLEAN ALL DUPLICATES AND ADD FRESH PRANAM SOFTWARE PRODUCTS
-- Run this ONCE in Supabase SQL Editor
-- ============================================================================

-- ============================================================================
-- STEP 1: DELETE ALL EXISTING PRODUCTS (removes duplicates)
-- ============================================================================
DELETE FROM public.products;

-- ============================================================================
-- STEP 2: ADD 7 PRANAM SOFTWARE PRODUCTS - FRESH
-- ============================================================================
...
-- ============================================================================
-- VERIFICATION - Check all products added successfully
-- ============================================================================
SELECT '✅ SUCCESS! Fresh products added without duplicates' as status;
SELECT COUNT(*) as total_products FROM public.products;
SELECT name, category, sort_order FROM public.products ORDER BY sort_order;

-- ============================================================================
-- Check for duplicates (should show 0 rows)
-- ============================================================================
SELECT name, COUNT(*) as duplicate_count FROM public.products GROUP BY name HAVING COUNT(*) > 1;
